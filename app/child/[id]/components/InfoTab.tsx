      ...
      <Card className="border-0 shadow-lg bg-white">
        <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white border-b-0 rounded-t-lg">
          <CardTitle className="flex items-center">
            ...
            <div>
              <span className="text-xl font-bold">{t.child.basic_information}</span>
              <p className="text-blue-100 text-sm font-normal mt-1">Personal identification and contact details</p>
            </div>
          </CardTitle>
        </CardHeader>
      ...
      <Card className="border-0 shadow-lg bg-white">
        <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white border-b-0 rounded-t-lg">
          <CardTitle className="flex items-center">
            ...
            <div>
              <span className="text-xl font-bold">{t.child.demographics_and_names}</span>
              <p className="text-green-100 text-sm font-normal mt-1">Personal demographics and name variations</p>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent className="p-8">
      ...
      <Card className="border-0 shadow-lg bg-white">
        <CardHeader className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white border-b-0 rounded-t-lg">
          <CardTitle className="flex items-center">
            ...
            <div>
              <span className="text-xl font-bold">{t.child.primary_address}</span>
              <p className="text-purple-100 text-sm font-normal mt-1">Current residential address information</p>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent className="p-8">
