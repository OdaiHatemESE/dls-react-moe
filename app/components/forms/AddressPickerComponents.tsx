          ...
          <div className="space-y-3">
            ...
            {local.emirateNameEn && (
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase mb-0.5">
            ...
            <div className="bg-aegreen-50 dark:bg-aegreen-950/30 rounded-lg p-3 border border-aegreen-200 dark:border-aegreen-800">
              <p className="text-[10px] text-aegreen-700 dark:text-aegreen-400 font-semibold uppercase tracking-wide mb-2">
                {locale === "ar" ? "معلومات القطعة" : "PLOT INFORMATION"}
              </p>

              <div className="grid grid-cols-2 gap-2 text-xs">
                {(local.premisesPlotId || local.mainPlotId) && (
                  <div>
                    <p className="text-[10px] text-aegreen-700 dark:text-aegreen-400 uppercase tracking-wide mb-0.5">
                      PLOT ID
                    </p>
                    <p className="font-bold text-aegreen-900 dark:text-aegreen-200">
                      {local.premisesPlotId || local.mainPlotId}
                    </p>
                  </div>
                )}
                {local.houseNumber && (
                  <div>
                    ...
                    <p className="font-semibold text-aegreen-900 dark:text-aegreen-200">
                      {local.houseNumber}
                    </p>
                  </div>
                )}
            ...
            {(local.latitude || local.longitude) && (
              <div className="bg-orange-50 dark:bg-orange-950/30 rounded-lg p-3 border border-orange-200 dark:border-orange-700">
                <p className="text-[10px] text-orange-700 dark:text-orange-400 font-semibold uppercase tracking-wide mb-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  {local.latitude && (
                    <div>
                      <p className="text-[10px] text-orange-700 dark:text-orange-400 uppercase tracking-wide mb-0.5">
            ...
            {(local.fullAddressEn || local.fullAddressAr) && (
              <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3 border border-blue-200 dark:border-blue-800 space-y-1.5">
                ...
                {local.fullAddressAr && (
                  <>
                    <p className="text-[10px] text-blue-600 dark:text-blue-400 font-semibold uppercase tracking-wide mt-2">
                      {locale === "ar" ? "العنوان (عربي)" : "ADDRESS (ARABIC)"}
                    </p>
                    <p className="text-xs font-medium text-blue-900 dark:text-blue-100" dir="rtl">
                      {local.fullAddressAr}
                    </p>
                  </>
                )}
