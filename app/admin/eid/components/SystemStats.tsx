...
export function SystemStats() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: data?.overview?.informationUpdates?.updated || 0,
      subtitle: `${data?.overview?.informationUpdates?.updateRate || 0}% completion rate`,
      icon: FileCheck,
      color: "text-aegreen-600",
      bgColor: "bg-aegreen-50 dark:bg-gray-800",
    },
    {
      title: "Conduct Signed",
      value: data?.overview?.informationUpdates?.withConductSigned || 0,
      subtitle: `${data?.overview?.informationUpdates?.conductSignRate || 0}% signed`,
      icon: CheckCircle,
      color: "text-blue-600",
