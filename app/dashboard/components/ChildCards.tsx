...
export default function ChildCards() {
  ...
  return (
    <div className="mb-12">
              ...
              <div className="relative p-4">
                ...
                <div className="relative">
                  ...
                  <Link
                    ...
                    className={clsx(
                      "flex items-center justify-center gap-2 w-full px-3 py-2 text-xs font-semibold",
      ...
      <div className="hidden lg:block relative overflow-hidden bg-card rounded-xl ">
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-6">
                      <Badge 
                        className={`${genderLabel.toLowerCase().includes('male') || genderLabel.includes('ذكر') 
                          ...
                          : 'bg-secondary/10 border-secondary/20 text-secondary-foreground hover:bg-secondary/20'} ${locale === 'ar' ? 'text-xs font-medium px-2 py-1' : 'text-xs font-medium px-2 py-1'} transition-colors duration-200`}
                      >
                        <svg className={`w-2.5 h-2.5 ${locale === 'ar' ? 'ml-1' : 'mr-1'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        {genderLabel}
                      </Badge>
                    ...
                    <td className="px-6 py-6">
                      ...
                      >
                        <svg className="w-3 h-3 transition-transform group-hover/button:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                        <span className="font-bold">{locale === 'ar' ? 'عرض الملف' : 'View Profile'}</span>
                        <ChevronRightIcon className={clsx(
                          "w-3 h-3 transition-all duration-200 group-hover/button:scale-110",
