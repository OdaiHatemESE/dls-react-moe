...
import type { StudentProfileV1, StudentParentInfo } from "@/app/types/studentprofile";
...
export type ParentConductAggregatedResponse = {
  ...
  parentInfo: StudentParentInfo | BasicInfoResponse | null;
  schoolInfo: unknown | null;
};
